            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        ...
                        <a href="salesreport" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i
                                class="fas fa-arrow-left fa-sm text-white-50"></i> Back</a>
                    </div>

                    <!-- Content Row -->
                    <div class="row">
                        <?php $gatSale = new SaleController(); $gatSale->showSaleReport($_POST['checkFrom'],$_POST['checkTo']); $getName =  new CustomerController();  ?>
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="p-5">
                                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                                Sales Log Between <?=date("jS F, Y",strtotime($_POST['checkFrom'])) ?> And <?= date("jS F, Y",strtotime($_POST['checkTo'])) ?> </div>
                                                ...
                                                <div class="table-responsive">
                                                    <table class="table table-bordered table-striped" id="dataTable" width="100%" cellspacing="0">
                                                        ...
                                                        <tbody>
                                                            <?php $sn=0; if($saleRpt != null){ foreach ($saleRpt as $asale) { $sn++;
